...
class NewUserZone {
  NewUserZone({
    ...
    required this.productNavigationLabel,
    required this.categoryNavigationLabel,
    required this.couponNavigationLabel,
    required this.productSlogan,
    required this.categorySlogan,
    required this.couponSlogan,
    this.status,
    this.isFeatured,
    this.createdBy,
    this.updatedBy,
    ...
    required this.couponCategories,
  });
  ...
  factory NewUserZone.fromJson(Map<String, dynamic> json) => NewUserZone(
        ...
        coupon: json["coupon"],
        couponCategories: json["coupon_categories"],
      );
