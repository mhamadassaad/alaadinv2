...
class OrderAddress {
  OrderAddress({
    ...
    required this.billToSameAddress,
    ...
    required this.createdAt,
    required this.updatedAt,
    required this.getShippingCountry,
    required this.getShippingState,
    required this.getShippingCity,
    required this.getBillingCountry,
    required this.getBillingState,
    required this.getBillingCity,
  });
