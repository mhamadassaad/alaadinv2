...
class RefundOrder {
  RefundOrder({
    ...
    required this.checkConfirmed,
    required this.order,
    required this.shippingGateway,
    required this.pickUpAddressCustomer,
  ...
  factory RefundOrder.fromJson(Map<String, dynamic> json) => RefundOrder(
        ...
        shippingGateway: json["shipping_gateway"],
        pickUpAddressCustomer: json["pick_up_address_customer"],
