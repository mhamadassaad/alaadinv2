...
//   //var products = ProductDetailsModel(data: null).obs;
...
//       print(e);
//     }
//     return ProductDetailsModel(data: discountType);
//   }
...
//             .toList();
//         visibleSKU.value =
//             products.value.data.product.skus.first as List<ProductSku>;
...
//           shippingValue.value = products.value.data.product.shippingMethods
//               .first as List<ShippingMethodElement>;
//         });
//       } else {
...
//         productSKU.value =
//             SkuData.fromJson(returnData['data']) as List<SkuData>;
