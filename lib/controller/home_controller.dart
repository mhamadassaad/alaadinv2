...
class HomeController extends GetxController {
    ...
    try {
      ...
      await http.get(Uri.parse(URLs.FLASH_DEALS)).then((value) {
        ...
        if (value is FlashDealModel) {
          flashDealData.value = value.flashDeal.allProducts.data
              .take(10)
              .cast<FlashDealDataElement>()
              .toList();
    ...
    try {
      ...
      await _dio.get(URLs.ALL_CATEGORY + '/$categoryId', queryParameters: {
        ...
        print(
            ...
            'catAllData.value len  ${catAllData.value}');
  ...
  Future<List<ProductModel>> getBrandProducts() async {
    ...
    try {
      ...
      await _dio.get(URLs.ALL_BRAND + '/$brandId', queryParameters: {
        ...
        brandAllData.value =
            SingleBrandModel.fromJson(value.data) as List<SingleBrandModel>;
  ...
  Future<List<SingleBrandModel>> getBrandFilterData() async {
    try {
      await _dio.get(URLs.ALL_BRAND + '/$brandId', queryParameters: {
        'page': brandPageNumber,
      }).then((value) {
  ...
  Future<List<ProductModel>> getRecommendedProducts() async {
    AllRecommendedModel parentCategoryElement =
        <AllRecommendedModel>[].obs as AllRecommendedModel;
    try {
