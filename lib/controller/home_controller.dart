...
class HomeController extends GetxController {
  ...
  var bgColor = 0.obs;
  var textColor = 0.obs;
  late DateTime flashDealEndDate;
  ...
  Future<void> getCategories() async {
    try {
      ...
      await _dio
        ...
        allCategoryList.value = data.data
            .where((element) => element.parentId == 0)
            .cast<CategoryData>()
            .toList();
  ...
  Future<void> getSubCategories({required int categoryId}) async {
    try {
      ...
      await _dio
        ...
        singleCat.value = value as List<SingleCategory>;
      });
    } catch (e) {
  ...
  Future<void> getAllBrand() async {
    try {
      ...
      await _dio.get(URLs.ALL_BRAND).then((value) {
        var data = new Map<String, dynamic>.from(value.data);
        return BrandsMain.fromJson(data);
      }).then((value) async {
        allBrands.value = value.data.cast<BrandData>();
        chunkedBrands
    ...
    try {
      ...
      await _dio
        ...
        if (value is NewUser.NewUserZoneModel) {
          ...
          newUserZoneCoupon.value =
              value.newUserZone.coupon as List<NewUser.NewUserZoneCoupon>;
        }
      });
    } catch (e) {
  ...
  //     required FilterColorValue colorValue}) async {
  //   if (isColor) {
  ...
  //                 isColor: true, colorValue: colorValue, typeId: typeId, value:value));
  ...
  //             (element) => element.filterTypeId.toString() == typeId.toString(),
  //             orElse: addIfNoAttribute(
  //                 value: value, typeId: typeId, isColor: false, colorValue: colorValue));
  ...
  Future<List<ProductModel>> getCategoryProducts() async {
    CategoryData parentCategoryElement = <CategoryData>[].obs as CategoryData;
    try {
      ...
      await _dio.get(URLs.ALL_CATEGORY + '/$categoryId', queryParameters: {
        ...
        catAllData.value =
            SingleCategory.fromJson(value.data) as List<SingleCategory>;
        ...
        category.value = parentCategoryElement as List<CategoryData>;
  ...
  // Future<List<SingleCategory>> getCategoryFilterData() async {
  //   try {
  //     // isProductsLoading(true);
  //     // isMoreLoading(true);
  //     await _dio.get(URLs.ALL_CATEGORY + '/$categoryId', queryParameters: {
  ...
  //       catAllData.value = SingleCategory.fromJson(value.data) as List<SingleCategory>;
  ...
  //   BrandData allBrandModelDatum = <BrandData>[].obs as BrandData;
  //   try {
  ...
  //       brandAllData.value = SingleBrandModel.fromJson(value.data) as List<SingleBrandModel>;
  ...
  //   AllProducts parentCategoryElement = <AllProducts>[].obs as AllProducts;
  //   try {
  //     isBrandsProductsLoading(true);
  //     isMoreBrandLoading(true);
  //     await _dio
  ...
  Future<List<FlashDealDataElement>> getFlashDealsData() async {
    FlashDealData flashDeals = <FlashDealData>[].obs as FlashDealData;
    try {
  ...
  //   AllRecommendedModel parentCategoryElement = <AllRecommendedModel>[].obs as AllRecommendedModel;
  //   try {
  ...
  //   RxList<AllRecommendedModel> parentCategoryElement = <AllRecommendedModel>[].obs;
  //   try {
  ...
  //     }).then((value) {
  //       final data = new Map<String, dynamic>.from(value.data);
  //       parentCategoryElement = AllRecommendedModel.fromJson(data) as RxList<AllRecommendedModel>;
  //       if (parentCategoryElement.data.length == 0) {
  ...
  Rx<HomePageModel> homePageModel = <HomePageModel>[].obs as Rx<HomePageModel>;
