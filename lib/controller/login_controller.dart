...
//import 'package:amazcart/controller/notification_controller.dart';

//final PushNotificationController _pushNotC = PushNotificationController();
...
class LoginController extends GetxController {
  ...
  late String loadToken;
//Hol Bedi yehon la f3l el login
  ...
  Future<UserClass?> getProfileData() async {
    ...
    try {
      ...
      if (products != null) {
        profileData.value = products as List<UserClass>;
...
////////////////////////////
//Hydi el function la el login fetchUserLogin darori
////////////////////
  // Future<bool> fetchUserLogin({required String email, required String password}) async {
  //   try {
  //     isLoading(true);
...
////////////////////
  ...
  //     _pushNotC.setFcmToken(fcmToken);
